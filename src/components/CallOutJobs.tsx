...
const CallOutJobs: React.FC<CallOutJobsProps> = ({ jobs, clients, onAdd, onEdit }) => {
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left text-slate-500">
          ...
          <tbody>
            ...
            {jobs.length === 0 && (
                <tr>
                    <td colSpan={7} className="text-center py-10 text-slate-500">No call-out jobs found.</td>
                </tr>
            )}
          </tbody>
        </table>
