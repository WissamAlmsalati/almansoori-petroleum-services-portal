...
import { UserGroupIcon, ShieldCheckIcon, ClipboardDocumentListIcon, ChevronDownIcon, XCircleIcon } from '../components/Icons';
...
const Scheduler: React.FC<{
    ...
    const { employees, crews, patterns, schedules } = data;
...
const FRMS: React.FC<{
    data: { employees: Employee[], crews: Crew[], schedules: CrewSchedule[], patterns: ShiftPattern[] },
    onUpdate: () => void,
    currentUser: any
}> = ({ data, onUpdate, currentUser }) => {
...
const Handover: React.FC<{
    ...
    const handleCreateReport = async (e: React.FormEvent) => {
        ...
        try {
            ...
            onUpdate(); // Trigger a full refetch on main component
...
const Timesheet: React.FC = () => {
    ...
    const renderContent = () => {
        if (isLoading || !data || !user) {
            return <Spinner text="Loading Operations Center..." />;
        }
        switch (activeTab) {
