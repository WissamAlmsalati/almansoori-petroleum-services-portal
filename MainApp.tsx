    ...
    switch (activeView) {
      case 'Dashboard':
        return <Dashboard 
               ...
               />;
      case 'Clients':
        return <Clients clients={clients} onAdd={() => setModalType('addClient')} onEdit={handleOpenEditClientModal} onDelete={handleDeleteClient} isLoading={loading} />;
      case 'Sub-Agreements':
        return <SubAgreements agreements={agreements} clients={clients} tickets={tickets} onAdd={() => setModalType('addAgreement')} onEdit={handleOpenEditAgreementModal} onDelete={handleDeleteAgreement} isLoading={loading} />;
